...
public enum ParticleEffect {
	...
	WATER_BUBBLE("bubble", 4, -1,
			new ParticleProperty[] { ParticleProperty.DIRECTIONAL, ParticleProperty.REQUIRES_WATER }),
	...
	FALLING_DUST("fallingdust", 46, 10, new ParticleProperty[] { ParticleProperty.REQUIRES_DATA });
	...
	private static boolean isDataCorrect(ParticleEffect effect, ParticleData data) {
		return ((effect == BLOCK_CRACK) || (effect == BLOCK_DUST) || (effect == FALLING_DUST))
	...
	public void display(Location loc, int i, int j, int k, int l, int m) {
	}
	...
	public static final class ParticlePacket {
		...
		public ParticlePacket(ParticleEffect effect, ParticleEffect.ParticleColor color, boolean longDistance) {
			...
			if((effect == ParticleEffect.REDSTONE) && ((color instanceof ParticleEffect.OrdinaryColor))
					&& (((ParticleEffect.OrdinaryColor) color).getRed() == 0)) {
